        ...
        <div className="grid grid-cols-2 gap-8 py-8 text-xs md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/category/framework" className="text-gray-600 hover:text-red-600">
                  フレームワーク
                </Link>
              </li>
              <li>
                <Link href="/category/marketing" className="text-gray-600 hover:text-red-600">
                  マーケティング
                </Link>
              </li>
              <li>
                <Link href="/category/design" className="text-gray-600 hover:text-red-600">
                  デザイン
                </Link>
              </li>
              <li>
                <Link href="/category/business" className="text-gray-600 hover:text-red-600">
                  ビジネス
                </Link>
              </li>
            </ul>
