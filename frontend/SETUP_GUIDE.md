...
```bash
NEXT_PUBLIC_WORDPRESS_GRAPHQL_URL=https://wpcore-l.tooling-hub.com/graphql
```
...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'wpcore-l.tooling-hub.com', // WordPressのドメイン
        port: '',
        pathname: '/**',
      },
    ],
...
const GRAPHQL_URL = process.env.NEXT_PUBLIC_WORDPRESS_GRAPHQL_URL ||
  'https://wpcore-l.tooling-hub.com/graphql';
...
? What's your project's name? core-language-hub
...
```
https://core-language-hub.vercel.app
```
...
2. リポジトリ名を入力（例: `core-language-hub`）
...
git branch -M main
git remote add origin https://github.com/[ユーザー名]/core-language-hub.git
